...
const NewReviewBox = ({text1, text2, text3, imgsrc}) => {
    return <View >
        <TouchableOpacity style={styles.buttonBox}>
            ...
            <Image style={styles.msg} source={require('../../images/blue-user.png')}></Image>
        </TouchableOpacity>
    </View>
}
